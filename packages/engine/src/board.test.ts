...
describe("cellIndex", () => {
  // spec: game-engine/board-geometry / DOWNSTREAM IMPACT note 3 — row-major y * boardSize + x
...
describe("isInner", () => {
  // spec: game-engine/board-geometry — inner cells are the (boardSize-2)^2 cells off the border
...
describe("fertileGroundEnabled", () => {
  // spec: game-engine/item-spawning#eligibility — derived from the board, not config
