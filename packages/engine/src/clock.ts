// Chess-timer arithmetic. spec: 01 §2.9 (game-engine/chess-timer..040).
//
...
// resolution when every team has declared (game-engine/chess-timer) — is module 04's
...
// spec: game-engine/chess-timer (explicit declare) and game-engine/chess-timer (clock expiry invokes the
