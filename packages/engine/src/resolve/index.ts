...
// win check → event derivation (game-engine/turn-resolution-model..052, game-engine/food-and-growth).
import type {
  GameOutcome,
  GameRuntimeConfig,
  GameState,
 ...
 */
// spec: game-engine/turn-resolution-model — staged resolution, commit as sole writer.
 ...
 * the order-shuffle property test that machine-checks game-engine/turn-resolution-model's
