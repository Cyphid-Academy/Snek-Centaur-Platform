<script lang="ts">
const title = "Snek Centaur Server";
const subtitle = "Reference Implementation";
</script>
...
<main>
  ...
  <ul>
    <li><a href="/play">Team counter race — the identity demo</a></li>
    <li><a href="/sign-in">Sign in through the platform</a></li>
