...
import TeamCounterRow from "./team_counter_table";
...
const tablesSchema = __schema({
  teamCounter: __table({
    name: 'team_counter',
    indexes: [
      { accessor: 'teamId', name: 'team_counter_team_id_idx_btree', algorithm: 'btree', columns: [
        'teamId',
      ] },
    ],
    constraints: [
      { name: 'team_counter_team_id_key', constraint: 'unique', columns: ['teamId'] },
    ],
  }, TeamCounterRow),
});
...
const reducersSchema = __reducers(
  __reducerSchema("increment", IncrementReducer),
  __reducerSchema("seed_game", SeedGameReducer),
);
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `teamCounter` instead. This alias will be removed in the next major version. */
    readonly "team_counter": Omit<typeof tablesSchema.schemaType.tables["teamCounter"], "accessorName"> & { readonly accessorName: "team_counter" };
  };
};
...
export type DbView = __DbViewBase & {
  /** @deprecated Use `teamCounter` instead. This alias will be removed in the next major version. */
  readonly "team_counter": __DbViewBase["teamCounter"];
};

type __TablesBase = __QueryBuilder<typeof tablesSchema.schemaType>;
export type Tables = __TablesBase & {
  /** @deprecated Use `teamCounter` instead. This alias will be removed in the next major version. */
  readonly "team_counter": __TablesBase["teamCounter"];
};
