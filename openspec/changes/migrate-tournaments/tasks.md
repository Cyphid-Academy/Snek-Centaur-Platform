...
- [ ] 2.1 On explicit author instruction, `pnpm spec:fold migrate-tournaments` then `openspec archive --skip-specs -y migrate-tournaments` at the tail of the PR that completes the implementation (fold enforces capability-dependency order)
