...
- [ ] 2.1 On explicit author instruction, `pnpm spec:fold migrate-replay-and-audit` then `openspec archive --skip-specs -y migrate-replay-and-audit` at the tail of the PR that completes the implementation (fold enforces capability-dependency order)
