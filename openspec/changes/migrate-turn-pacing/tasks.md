...
- [ ] 2.1 On explicit author instruction, `pnpm spec:fold migrate-turn-pacing` then `openspec archive --skip-specs -y migrate-turn-pacing` at the tail of the PR that completes the implementation (fold enforces capability-dependency order)
