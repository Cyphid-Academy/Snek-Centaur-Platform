...
- **Module 01 — game-rules**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/01-game-rules.review.md`.
- **Module 02 — platform-architecture**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/02-platform-architecture.review.md`.
- **Module 03 — auth-and-identity**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/03-auth-and-identity.review.md`.
- **Module 04 — stdb-engine**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/04-stdb-engine.review.md`.
- **Module 05 — convex-platform**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/05-convex-platform.review.md`.
- **Module 06 — centaur-state**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/06-centaur-state.review.md`.
- **Module 07 — bot-framework**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/07-bot-framework.review.md`.
- **Module 08 — centaur-server-app**: Phase 2 complete. 0 REVIEW items open. Decision log: `specs/08-centaur-server-app.review.md`.
